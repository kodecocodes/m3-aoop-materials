...
let emergencyContact = EmergencyContactCard(emergencyName: "Cold Stone Creamery", phoneNumber: "555")
let emergencyContact2 = EmergencyContactCard(emergencyName: "Rifftrax", phoneNumber: "")

print("emergency 1: \(emergencyContact?.contactInformation() ?? "None")")
print("emergency 2: \(emergencyContact2?.contactInformation() ?? "None")")
